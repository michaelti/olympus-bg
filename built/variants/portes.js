...
class Portes extends game_1.Board {
    constructor() {
        ...
        this.initGame = function () {
            ...
            this.pips[19] = game_1.Pip(5, game_1.Player.white);
            ...
            this.bar[game_1.Player.black] = this.pips[25];
            this.bar[game_1.Player.white] = this.pips[0];
        };
        // Is the move valid?
        // from:    Move from pip # <eg. 1>
        // to:      Move to pip # <eg. 4>
        // return:  Returns a boolean
        this.isMoveValid = function (from, to) {
            to = game_1.clamp(to);
